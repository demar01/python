...
#we create a random directory and we are going to write something random of a given size in a file 
# I guess we need sorted at the end cuz return values may not be return sorted. 