...
def get_users_for_shell(passwd_output: str = PASSWD_OUTPUT,
    ...
    """
    return [s.split(":", 1)[0] for s in passwd_output.splitlines(keepends=False) #this will prevent \n line breaks to be included in the resulting list.
            if s.endswith(f"/bin/{grep_shell}")]



# hi="hello"
# {hi} #this does word replacement and returns {'hello'}